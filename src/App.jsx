...
export default function App() {
  ...
  return (
    <>
      {showIntro && (
        <EventHorizon onComplete={handleIntroComplete} />
      )}

      <AppShell navVisible={navVisible}>
        {/* Zone 0 — Landing after intro */}
        <div
          id="event-horizon"
        ...
        {/* Footer */}
        <footer
          className="py-12 px-6 border-t border-white border-opacity-5"
        ...
        >
          ...
          justify-between items-center gap-4">
            ...
            >
              ...
              groupsales@mallofamerica.com · 952.883.8809
            </p>
            <button
      ...
      {showEventsModule && (
        <>
          <div
            ...
            onClick={() => setShowEventsModule(false)}
          />
